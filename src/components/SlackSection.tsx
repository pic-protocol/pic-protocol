      ...
      <div className="max-w-120 md:max-w-300 mx-auto w-full bg-[#00543D] rounded-4xl p-12 md:p-16 md:py-15 grid grid-cols-1 md:grid-cols-12 gap-x-16 justify-between items-center overflow-hidden relative">
        ...
        <div className="flex flex-col col-span-1 md:col-span-7 relative z-10">
          ...
          <a
            ...
            className="text-center ml-auto md:ml-0 mr-auto leading-none py-3.5 bg-white hover:bg-white/90 hover:text-black/80 text-black tracking-[-0.48px] cursor-pointer px-6 border border-white/20 rounded-xl text-base font-semibold transition-all duration-300 hover:shadow-[0_0_24px_rgba(255,255,255,0.2)]"
          >
            Join Community →
          </a>
        </div>
